...
<h3>Plese Select the Programing Information </h3>
   <div>
   <asp:Label ID="LBL_PROG" runat="server" Text="Programing"></asp:Label>  
...
<div style="margin-top:20px"></div>
    ...
    EnableViewState="False" Height="108px" Width="511px" Font-Bold="True" 
            ...
            GridLines="Horizontal" ShowFooter="True"><%-- AllowPaging="true"
    OnPageIndexChanging="OnPageIndexChanging" PageSize="5" DataKeyNames="SupplierID" DataSourceID="SuppliersDataSource" --%>
           ...
           <Columns>
               ...
               <asp:TemplateField HeaderText="available ">
                   <ItemTemplate>
                       <asp:RadioButton ID="RBT_AVAILABLE_PRO" runat="server" GroupName="InfoGroup" 
                           Width="100" />
                   </ItemTemplate>
               </asp:TemplateField>
               <asp:TemplateField HeaderText="Notavailable">
                   <ItemTemplate>
                       <asp:RadioButton ID="RBT_NOTAVAILABLE_PRO" runat="server" GroupName="InfoGroup" 
                           Width="100" />
                   </ItemTemplate>
               </asp:TemplateField>
