<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminEditReq.aspx.cs" Inherits="Data_analytic.AdminEditReq"  enableEventValidation="false" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
      <ContentTemplate>
<asp:GridView ID="grdRequirment" runat="server" AutoGenerateColumns="False"
...
<asp:Button ID="btnBack" runat="server" Text="Back"   Height="43px" 
        style="margin-left: 0px" Width="146px"  BackColor="#55a6dd" 
             BorderColor="#666768" BorderStyle="Solid" onclick="btnBack_Click"/>
<asp:Button ID="btnSave" runat="server" Text="Save" onclick="btnSave_Click"  Height="43px" style="margin-left: 0px" Width="146px"  BackColor="#55a6dd" 
