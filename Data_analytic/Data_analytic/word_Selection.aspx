<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="word_Selection.aspx.cs" Inherits="Data_analytic.word_Selection" %>
    ...
    $(function () {
        $("[id$=txtSearch]").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/word_Selection.aspx/GetCustomers") %>',
